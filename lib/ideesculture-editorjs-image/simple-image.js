...
class IdeescultureEditorjsImage {
  ...
  constructor({data, api, config}){
    ...
    this.settings = [
      ...
      {
        name: 'floatLeft',
        icon: `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" viewBox="0 0 512 512" xml:space="preserve"><g><path d="M56.9,56.9v28.4h113.8v113.8H56.9h0l0-113.8v0V56.9V28.4C25.5,28.5,0,53.9,0,85.3v113.8C0,230.5,25.5,256,56.9,256l113.8,0c31.4,0,56.9-25.5,56.9-56.9V85.3c0-31.4-25.5-56.9-56.9-56.9H56.9V56.9z"/><path d="M312.9,142.2h170.7c15.7,0,28.4-12.7,28.4-28.4c0-15.7-12.7-28.4-28.4-28.4H312.9c-15.7,0-28.4,12.7-28.4,28.4C284.4,129.5,297.2,142.2,312.9,142.2"/><path d="M312.9,256h170.7c15.7,0,28.4-12.7,28.4-28.4c0-15.7-12.7-28.4-28.4-28.4H312.9c-15.7,0-28.4,12.7-28.4,28.4C284.4,243.3,297.2,256,312.9,256"/><path d="M28.4,369.8h455.1c15.7,0,28.4-12.7,28.4-28.4c0-15.7-12.7-28.4-28.4-28.4H28.4C12.7,312.9,0,325.6,0,341.3C0,357,12.7,369.8,28.4,369.8"/><path d="M28.4,483.6h455.1c15.7,0,28.4-12.7,28.4-28.4c0-15.7-12.7-28.4-28.4-28.4H28.4C12.7,426.7,0,439.4,0,455.1C0,470.8,12.7,483.6,28.4,483.6"/></g></svg>`
      },
      {
        name: 'floatRight',
        icon: `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve"><g><path d="M341.3,56.9v28.4h113.8v113.8H341.3h0l0-113.8v0V56.9V28.4c-31.4,0-56.9,25.5-56.9,56.9v113.8c0,31.4,25.5,56.9,56.9,56.9l113.8,0c31.4,0,56.9-25.5,56.9-56.9l0-113.8c0-31.4-25.5-56.9-56.9-56.9H341.3V56.9z"/><path d="M28.4,142.2h170.7c15.7,0,28.4-12.7,28.4-28.4c0-15.7-12.7-28.4-28.4-28.4H28.4C12.7,85.3,0,98.1,0,113.8C0,129.5,12.7,142.2,28.4,142.2"/><path d="M28.4,256h170.7c15.7,0,28.4-12.7,28.4-28.4c0-15.7-12.7-28.4-28.4-28.4H28.4C12.7,199.1,0,211.8,0,227.6C0,243.3,12.7,256,28.4,256"/><path d="M28.4,369.8h455.1c15.7,0,28.4-12.7,28.4-28.4c0-15.7-12.7-28.4-28.4-28.4H28.4C12.7,312.9,0,325.6,0,341.3C0,357,12.7,369.8,28.4,369.8"/><path d="M28.4,483.6h455.1c15.7,0,28.4-12.7,28.4-28.4c0-15.7-12.7-28.4-28.4-28.4H28.4C12.7,426.7,0,439.4,0,455.1C0,470.8,12.7,483.6,28.4,483.6"/></g></svg>`
      }
