...
class SimpleVideo {
  ...
  static get toolbox() {
    return {
      title: 'Video',
      icon: '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"· viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve"><g><path d="M0,62.3v387.5h512V62.3H0z M62.8,125.1h386.4v261.9H62.8V125.1z M198.6,170.7v174.4l150.8-87.5L198.6,170.7z"/></g></svg>'
    };
  }
  ...
  static get pasteConfig() {
    return {
      ...
      files: {
        mimeTypes: ['video/*'],
        extensions: ['mp4', 'mov', 'avi'] // You can specify extensions instead of mime-types
      },
      patterns: {
        image: /https?:\/\/\S+\.(mp4|mov|avi)$/i
      }
    };
  }
  ...
  renderSettings(){
    ...
    this.settings.forEach( tune => {
      ...
      button.addEventListener('click', () => {
        ...
        $('.simple-video.floatLeft').parent().addClass('floatLeft');
        $('.simple-video.floatRight').parent().addClass('floatRight');
      });
